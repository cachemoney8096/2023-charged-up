...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    operatorController
        .rightBumper()
        .onTrue(new InstantCommand(() -> lights.toggleCode(Lights.LightCode.CONE), lights));
    operatorController.leftTrigger().onTrue(new InstantCommand(lift::closeGrabber, lift));
    operatorController.leftTrigger().onFalse(new InstantCommand(lift::openGrabber, lift));
