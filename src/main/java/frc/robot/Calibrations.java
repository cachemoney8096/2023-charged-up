...
public final class Calibrations {
  ...
  public static final double ARBITRARY_ELEVATOR_FEED_FORWARD_VOLTS = PLACEHOLDER_DOUBLE;
  ...
  public static final double ELEVATOR_MAX_ACCELERATION_IN_PER_SECOND_SQUARED = PLACEHOLDER_DOUBLE,
