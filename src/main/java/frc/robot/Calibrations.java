...
public final class Calibrations {
  ...
  public static final double INTAKE_DEPLOY_MAX_ACCELERATION_RPM = PLACEHOLDER_DOUBLE,
      INTAKE_DEPLOY_MAX_VELOCITY_RPM = PLACEHOLDER_DOUBLE,
      INTAKE_DEPLOY_MIN_OUTPUT_VELOCITY_RPM = PLACEHOLDER_DOUBLE,
      INTAKE_DEPLOY_ALLOWED_CLOSED_LOOP_ERROR = PLACEHOLDER_DOUBLE;

  /** Parameters for arm SmartMotion */
  public static final double ARM_MAX_ACCELERATION_RPM = PLACEHOLDER_DOUBLE,
      ARM_MAX_VELOCITY_RPM = PLACEHOLDER_DOUBLE,
      ARM_MIN_OUTPUT_VELOCITY_RPM = PLACEHOLDER_DOUBLE,
      ARM_ALLOWED_CLOSED_LOOP_ERROR = PLACEHOLDER_DOUBLE;
}
