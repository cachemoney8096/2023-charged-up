...
public final class Cal {
  ...
  public static final class SwerveModule {
    ...
    /** Input meters/second, output [-1,1] */
    public static final double DRIVING_PITCHED_P = 2.0,
        DRIVING_PITCHED_I = 0.0,
        DRIVING_PITCHED_D = 0.1,
        DRIVING_PITCHED_FF = 1.15 / Constants.SwerveModule.DRIVE_WHEEL_FREE_SPEED_METERS_PER_SECOND;
