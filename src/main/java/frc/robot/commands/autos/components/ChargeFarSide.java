...
public class ChargeFarSide extends SequentialCommandGroup {

  private double startXMeters = 0.0;
  private static final double NORM_SPEED_UP_CHARGE_STATION = -0.4;

  public ChargeFarSide(DriveSubsystem drive, double distanceMeters) {
    addCommands(
        new InstantCommand(
            () -> {
        ...
        new RunCommand(
            ...
            .until(
                () -> {
                  return (startXMeters - drive.getPose().getX()) > distanceMeters;
                }),
