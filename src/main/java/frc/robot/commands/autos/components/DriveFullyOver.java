            ...
            .until(
                () -> {
                  ...
                  boolean currentPitchNearZero =
                      ...
                      SmartDashboard.putNumber("Filtered Pitch deg", currentPitchDegrees);
                  SmartDashboard.putBoolean("Has been positive", pitchHasBeenBig);
                  SmartDashboard.putBoolean("Currently near zero", currentPitchNearZero);
